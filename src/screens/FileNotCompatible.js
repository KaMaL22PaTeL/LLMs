...
export default function FileNotCompatible({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Image source={require('../assets/fileinvalid.png')} style={{
                width: 60,
                height: 60,
                alignItems: 'center',
                alignContent: 'center',
            ...
            <PoppinsText bold={true} style={[styles.title, { color: Styles.colors.gray600, paddingLeft: 60, paddingRight: 60 }]}>
                The Filetype “ .cs”  is not compatible at this time, We only support the following filetypes:
                .txt, .pdf, .CSV.
            </PoppinsText>
